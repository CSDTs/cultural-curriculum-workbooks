...
import AdireCloth from "@/assets/aikr/create-1.png";
import KenteCloth from "@/assets/aikr/create-2.png";
import MudCloth from "@/assets/aikr/create-3.png";
import AdinkraCloth from "@/assets/aikr/create-4.jpeg";
...
export default function TraditionAndTech() {
	return (
		<NoResponse>
			...
			<Paragraph>Here are some base image samples. You can also upload an image of your own choosing.</Paragraph>
			<SimpleGrid columns={{ base: 1, md: 3, lg: 5 }} spacing={10} my={5}>
				<Box>
